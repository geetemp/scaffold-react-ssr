...
// export default function xhrVessel({url, body, method}) {
//   _pipelines = {};
//
//   return {
//     addPipe: (name, func) => {  //在管道中添加处理函数
//       _pipelines[name] = func;
//     },
//     removePipe: (name) => {  //在管道中删除处理函数
//       delete _pipelines[name];
//     },
//
//     require: ({url, body, method}) => {   //发送请求
//       xhr({url, body, method}).then((response) => {
//
//       })
//     }
//   }
